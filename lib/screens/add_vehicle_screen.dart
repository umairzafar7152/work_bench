...
class _AddVehicleScreenState extends State<AddVehicleScreen> {
              ...
              : SingleChildScrollView(
                  child: Container(
                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                          SizedBox(height: 10),Text('Vehicle Image: ', style: TextStyle(
                              color: Colors.black,
                              fontWeight: FontWeight.w900,
                              fontSize: 18)),
                          SizedBox(height: 7),
                          imageProfile(_pickedVehicleImage),
                          // GestureDetector(
                          //   onTap: () {
                          ...
                          // ),
                          SizedBox(height: 10),
                          SizedBox(height: 10),Text('Vehicle Name: ', style: TextStyle(
                              color: Colors.black,
                              fontWeight: FontWeight.w900,
                              fontSize: 18)),
                          SizedBox(height: 7),
                          ...
                          SizedBox(height: 10),
                          SizedBox(height: 10),Text('Vehicle Location: ', style: TextStyle(
                              color: Colors.black,
                              fontWeight: FontWeight.w900,
                              fontSize: 18)),
                          SizedBox(height: 7),
                          ...
                          SizedBox(height: 10),
                          SizedBox(height: 10),Text('Insurance: ', style: TextStyle(
                              color: Colors.black,
                              fontWeight: FontWeight.w900,
                              fontSize: 18)),
                          SizedBox(height: 7),
                            ...
                            onPressed: () async {
                              if (_pickedVehicleImage == null ||
                                ...
                                if (_pickedVehicleImage != null &&
                                    _insuranceFile != null) {
                                  Future.wait([
                                    _viewModel.uploadVehicleImage(
                                        File(_pickedVehicleImage.path)),
  ...
  Future<PickedFile> takePhoto(ImageSource source) async {
    ...
    setState(() {
      ...
      _pickedVehicleImage = pickedFile;
    });
    return _pickedFile;
  }
