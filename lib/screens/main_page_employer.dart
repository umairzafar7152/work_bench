...
import 'package:work_bench/screens/employer_edit_profile_screen.dart';
import 'package:work_bench/screens/employer_flha_list_screen.dart';
import 'package:work_bench/screens/employer_inspection_list_screen.dart';
...
class MainPageEmployer extends StatefulWidget {
  ...
  @override
  _MainPageEmployerState createState() => _MainPageEmployerState();
}
    ...
    return Container(
        ...
        child: Scaffold(
            ...
            leading: GestureDetector(
                onTap: () {
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => EditEmployerProfileScreen(employer: UserData.fromMap(_snapshot)))).then((value) {
                            if(value!=null) {
                              setState(() {
                                _snapshot = value;
                              });
                ...
                child: Padding(
                  ...
                  child: CircleAvatar(
                    backgroundImage: NetworkImage(
                        _snapshot != null
                            ? _snapshot['profileImage']==null || _snapshot['profileImage'] == ''
                            ? _avatarUrl
          ...
          body: _isLoading
            ...
            crossAxisCount: 2,
            children: <Widget>[
              categoryItems('Employees', 'assets/images/emp.png'),
              ...
              categoryItems('Jobs', 'assets/images/job.png'),
              categoryItems('Calculator', 'assets/images/calculator.png'),
              ...
              builder: (context) {
                switch(itemName) {
                  ...
                  case 'FLHA':
                    ...
                    break;
                  case 'Inspection':
                    return EmployerInspectionListScreen();
                    break;
                }
                return null;
              }),
