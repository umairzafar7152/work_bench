...
class VehicleDetailScreen extends StatefulWidget {
  VehicleDetailScreen({Key key, this.vehicle}) : super(key: key);
        ...
        getLocationPermissions().then((value1) {
          if (value1) {
            myCurrentLocation().then((_) {
              ...
              _lat = widget.vehicle.location.latitude;
              _long = widget.vehicle.location.longitude;
              _markers.clear();
              _markers.add(Marker(
                  ...
                  child: Container(
                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                          ...
                          CircleAvatar(
                              radius: 60,
                              backgroundImage: widget.vehicle.imageUrl != null
                                  ? NetworkImage(widget.vehicle.imageUrl)
                          ...
                          Padding(
                            ...
                            child: GestureDetector(
                              onTap: () async {
                                if (widget.vehicle.insuranceUrl != null &&
                                    widget.vehicle.insuranceUrl != '') {
                                  final status =
                                      await Permission.storage.request();
                                  if (status.isGranted) {
                                    await FlutterDownloader.enqueue(
                                      url: widget.vehicle.insuranceUrl,
